    ...
    <SafeAreaView style={{ flex: 1, justifyContent: 'space-around' }}>
      <View>
        ...
        <View style={{ padding: 14 }}>
          <TouchableOpacity style={{ backgroundColor: 'rgba(0,0,0,0.2)', padding: 10, borderRadius: 8, marginBottom: 20 }}>
            <TextInput placeholder='Localização'></TextInput>
          </TouchableOpacity>
          <TouchableOpacity style={{ backgroundColor: 'rgba(0,0,0,0.1)', padding: 10, borderRadius: 8, marginBottom: 20 }}>
